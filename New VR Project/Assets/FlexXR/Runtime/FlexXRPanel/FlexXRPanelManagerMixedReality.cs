...
namespace FlexXR.Runtime.FlexXRPanel
{
    public partial class FlexXRPanelManager
    {
        ...
        {
            var interactable = info.worldMesh.gameObject.AddComponent<UnityEngine.XR.Interaction.Toolkit.Interactables.XRSimpleInteractable>();
        ...
        private readonly Dictionary<UnityEngine.XR.Interaction.Toolkit.Interactors.XRRayInteractor,XRRayInteractorStateOnHoverExit> _xrRayInteractorStatesOnHoverExit = new();
        private readonly List<UnityEngine.XR.Interaction.Toolkit.Interactors.XRRayInteractor>                                 _xrRayInteractors         = new();
        
        private UnityEngine.XR.Interaction.Toolkit.Interactors.XRRayInteractor ActiveInteractor => _xrRayInteractors.Count > 0 ? _xrRayInteractors[0] : null;

        private void OnHoverEntered(HoverEnterEventArgs args)
        {
            switch (args.interactorObject)
            {
                case UnityEngine.XR.Interaction.Toolkit.Interactors.XRRayInteractor xrRayInteractor:
...
/*                    if (xrRayInteractor != _xrRayInteractors[0]) return;*/
                    ...
                    {
                        UnityEngine.XR.Interaction.Toolkit.Interactors.XRRayInteractor temp = _xrRayInteractors[0];
